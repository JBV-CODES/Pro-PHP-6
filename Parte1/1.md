...
-1.1 [¿Qué es POO?](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#qué-es-poo)
-1.2 [Ventajas de usar POO](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#ventajas-de-usar-poo)
-1.3 [Ejemplo del mundo real](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#ejemplo-del-mundo-real)
-1.4 [Conceptos POO](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#conceptos-poo)
-1.5 [Clases](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#clases)
-1.6 [Objetos](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#objetos)
-1.7 [Crear una clase](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#crear-una-clase)
-1.7 [Añadir un método](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#añadir-un-método)
-1.8 [Añadir una propiedad](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#añadir-una-propiedad)
-1.9 [Proteger acceso a variables miembro](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#proteger-acceso-a-variables-miembro)
-1.10 [Inicializar objetos](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#inicializar-objetos)
-1.11 [Destruir objetos](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#destruir-objetos)
-1.12 [Herencia](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#herencia)
-1.13 [Sobreescrbir métodos](https://github.com/JBV-CODES/Pro-PHP-6/blob/master/Parte1/1.md#sobrescribir-métodos)
-1.14 Preservar la funcionalidad del método principal
-1.15 Como funciona la herencia
-1.16 Interfaces : funcionamiento
-1.17 Encapsulado
-1.18 Cambios POO en PHP 6
-1.19 Resumen
