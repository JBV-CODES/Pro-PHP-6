...
?>
```
Un objeto derivado de la clase puede imprimir un saludo a cualquiera que lo invoque. Para invocar el objeto usamos el operador **->** 
```
<?php
...
> *el operador **->** se se usa siemprepara acceder a los métodos y propiedades del objeto.* 
> *PHP no usa el operador punto (.)*
